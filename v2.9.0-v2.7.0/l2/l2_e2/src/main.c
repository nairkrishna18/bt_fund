...
#define COMPANY_ID_CODE            0x0059 /* Company ID for Nordic Semiconductor ASA */
...
/* STEP 1 - Create an LE Advertising Parameters variable 
    step increase = 0.625ms
	Min delay = 20ms = 20/0.625 = 32 N
	Max delay = 10.24s = 1024/0.625 = 16384 N
	Advertising interval is set to 500 ms -> 500ms/0.625ms = 800 N
	As we discussed before, there will be a random delay added to avoid packet collisions.
************************************************************************************************/
